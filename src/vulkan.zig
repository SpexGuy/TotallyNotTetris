...
pub const enum_VkResult = extern enum {
    VK_SUCCESS = 0,
    VK_NOT_READY = 1,
    VK_TIMEOUT = 2,
    VK_EVENT_SET = 3,
...
pub const VK_KHR_EXTERNAL_FENCE_EXTENSION_NAME = c"VK_KHR_external_fence";
...
pub const VK_EXT_DEBUG_UTILS_EXTENSION_NAME = c"VK_EXT_debug_utils";
pub const VK_KHR_IMAGE_FORMAT_LIST_EXTENSION_NAME = c"VK_KHR_image_format_list";
pub const VK_NV_SHADER_SUBGROUP_PARTITIONED_EXTENSION_NAME = c"VK_NV_shader_subgroup_partitioned";
...
pub const VK_KHR_SWAPCHAIN_EXTENSION_NAME = c"VK_KHR_swapchain";
...
pub const VK_KHR_DISPLAY_SWAPCHAIN_EXTENSION_NAME = c"VK_KHR_display_swapchain";
...
pub const VK_KHR_RELAXED_BLOCK_LAYOUT_EXTENSION_NAME = c"VK_KHR_relaxed_block_layout";
...
pub const VK_GOOGLE_DISPLAY_TIMING_EXTENSION_NAME = c"VK_GOOGLE_display_timing";
...
pub const VK_NV_FILL_RECTANGLE_EXTENSION_NAME = c"VK_NV_fill_rectangle";
...
pub const VK_KHR_EXTERNAL_MEMORY_EXTENSION_NAME = c"VK_KHR_external_memory";
...
pub const VK_IMG_FILTER_CUBIC_EXTENSION_NAME = c"VK_IMG_filter_cubic";
pub const __UINT16_MAX__ = 65535;
pub const __CLOCK_T_TYPE = __SYSCALL_SLONG_TYPE;
pub const __x86_64 = 1;
pub const VK_EXT_SAMPLE_LOCATIONS_EXTENSION_NAME = c"VK_EXT_sample_locations";
pub const GLFW_KEY_COMMA = 44;
pub const VK_IMG_FORMAT_PVRTC_EXTENSION_NAME = c"VK_IMG_format_pvrtc";
pub const VK_EXT_CONSERVATIVE_RASTERIZATION_EXTENSION_NAME = c"VK_EXT_conservative_rasterization";
...
pub const VK_KHR_SURFACE_EXTENSION_NAME = c"VK_KHR_surface";
...
pub const VK_KHR_EXTERNAL_FENCE_FD_EXTENSION_NAME = c"VK_KHR_external_fence_fd";
pub const INT_FAST8_MAX = 127;
pub const __FLT_RADIX__ = 2;
pub const VK_KHR_VARIABLE_POINTERS_EXTENSION_NAME = c"VK_KHR_variable_pointers";
pub const __GLIBC_MINOR__ = 27;
pub const _STDINT_H = 1;
pub const VK_EXT_GLOBAL_PRIORITY_EXTENSION_NAME = c"VK_EXT_global_priority";
...
pub const VK_NV_CLIP_SPACE_W_SCALING_EXTENSION_NAME = c"VK_NV_clip_space_w_scaling";
pub const VK_EXT_debug_marker = 1;
pub const VK_KHR_maintenance2 = 1;
pub const __PRAGMA_REDEFINE_EXTNAME = 1;
pub const __FLT16_DECIMAL_DIG__ = 5;
pub const __CPU_MASK_TYPE = __SYSCALL_ULONG_TYPE;
pub const VK_NV_FRAMEBUFFER_MIXED_SAMPLES_EXTENSION_NAME = c"VK_NV_framebuffer_mixed_samples";
...
pub const VK_AMD_SHADER_TRINARY_MINMAX_EXTENSION_NAME = c"VK_AMD_shader_trinary_minmax";
pub const __INT_FAST16_TYPE__ = short;
pub const VK_SUBPASS_EXTERNAL = ~c_uint(0);
pub const __DBL_MAX_10_EXP__ = 308;
pub const __LDBL_MIN__ = 0.000000;
pub const __CLANG_ATOMIC_LLONG_LOCK_FREE = 2;
pub const __FSFILCNT64_T_TYPE = __UQUAD_TYPE;
pub const VK_EXT_DISCARD_RECTANGLES_EXTENSION_NAME = c"VK_EXT_discard_rectangles";
pub const VK_EXT_POST_DEPTH_COVERAGE_EXTENSION_NAME = c"VK_EXT_post_depth_coverage";
...
pub const VK_EXT_BLEND_OPERATION_ADVANCED_EXTENSION_NAME = c"VK_EXT_blend_operation_advanced";
pub const GLFW_MOUSE_BUTTON_1 = 0;
pub const VK_AMD_SHADER_CORE_PROPERTIES_EXTENSION_NAME = c"VK_AMD_shader_core_properties";
...
pub const VK_NV_DEDICATED_ALLOCATION_EXTENSION_NAME = c"VK_NV_dedicated_allocation";
...
pub const __UINT8_FMTx__ = c"hhx";
pub const VK_KHR_BIND_MEMORY_2_EXTENSION_NAME = c"VK_KHR_bind_memory2";
pub const __INTMAX_C_SUFFIX__ = L;
pub const VK_KHR_SHARED_PRESENTABLE_IMAGE_EXTENSION_NAME = c"VK_KHR_shared_presentable_image";
pub const __ORDER_LITTLE_ENDIAN__ = 1234;
pub const GLFW_KEY_KP_7 = 327;
pub const VK_AMD_SHADER_IMAGE_LOAD_STORE_LOD_EXTENSION_NAME = c"VK_AMD_shader_image_load_store_lod";
...
pub const VK_EXT_DEPTH_RANGE_UNRESTRICTED_EXTENSION_NAME = c"VK_EXT_depth_range_unrestricted";
...
pub const VK_KHR_INCREMENTAL_PRESENT_EXTENSION_NAME = c"VK_KHR_incremental_present";
...
pub const VK_KHR_SHADER_DRAW_PARAMETERS_EXTENSION_NAME = c"VK_KHR_shader_draw_parameters";
...
pub const VK_NVX_MULTIVIEW_PER_VIEW_ATTRIBUTES_EXTENSION_NAME = c"VK_NVX_multiview_per_view_attributes";
pub const VK_NVX_DEVICE_GENERATED_COMMANDS_EXTENSION_NAME = c"VK_NVX_device_generated_commands";
pub const VK_AMD_SHADER_TRINARY_MINMAX_SPEC_VERSION = 1;
pub const VK_NV_FRAGMENT_COVERAGE_TO_COLOR_EXTENSION_NAME = c"VK_NV_fragment_coverage_to_color";
...
pub const VK_AMD_TEXTURE_GATHER_BIAS_LOD_EXTENSION_NAME = c"VK_AMD_texture_gather_bias_lod";
...
pub const VK_EXT_DISPLAY_CONTROL_EXTENSION_NAME = c"VK_EXT_display_control";
...
pub const VK_EXT_SHADER_SUBGROUP_VOTE_EXTENSION_NAME = c"VK_EXT_shader_subgroup_vote";
pub const VK_KHR_SAMPLER_YCBCR_CONVERSION_EXTENSION_NAME = c"VK_KHR_sampler_ycbcr_conversion";
...
pub const VK_KHR_DEVICE_GROUP_CREATION_EXTENSION_NAME = c"VK_KHR_device_group_creation";
...
pub const VK_KHR_EXTERNAL_MEMORY_FD_EXTENSION_NAME = c"VK_KHR_external_memory_fd";
pub const VK_KHR_EXTERNAL_MEMORY_CAPABILITIES_EXTENSION_NAME = c"VK_KHR_external_memory_capabilities";
pub const GLFW_MAXIMIZED = 131080;
pub const VK_NV_EXTERNAL_MEMORY_CAPABILITIES_EXTENSION_NAME = c"VK_NV_external_memory_capabilities";
...
pub const __UINT_FAST64_FMTX__ = c"lX";
pub const VK_EXT_VERTEX_ATTRIBUTE_DIVISOR_EXTENSION_NAME = c"VK_EXT_vertex_attribute_divisor";
...
pub const VK_EXT_QUEUE_FAMILY_FOREIGN_EXTENSION_NAME = c"VK_EXT_queue_family_foreign";
...
pub const VK_EXT_VALIDATION_CACHE_EXTENSION_NAME = c"VK_EXT_validation_cache";
...
pub const VK_EXT_HDR_METADATA_EXTENSION_NAME = c"VK_EXT_hdr_metadata";
...
pub const VK_NV_GLSL_SHADER_EXTENSION_NAME = c"VK_NV_glsl_shader";
...
pub const VK_EXT_SWAPCHAIN_COLOR_SPACE_EXTENSION_NAME = c"VK_EXT_swapchain_colorspace";
...
pub const __UINT64_FMTX__ = c"lX";
pub const VK_KHR_SAMPLER_MIRROR_CLAMP_TO_EDGE_EXTENSION_NAME = c"VK_KHR_sampler_mirror_clamp_to_edge";
...
pub const VK_KHR_DRAW_INDIRECT_COUNT_EXTENSION_NAME = c"VK_KHR_draw_indirect_count";
...
pub const VK_EXT_DISPLAY_SURFACE_COUNTER_EXTENSION_NAME = c"VK_EXT_display_surface_counter";
...
pub const VK_KHR_DISPLAY_EXTENSION_NAME = c"VK_KHR_display";
...
pub const VK_KHR_GET_DISPLAY_PROPERTIES_2_EXTENSION_NAME = c"VK_KHR_get_display_properties2";
...
pub const VK_KHR_DEDICATED_ALLOCATION_EXTENSION_NAME = c"VK_KHR_dedicated_allocation";
...
pub const VK_AMD_GCN_SHADER_EXTENSION_NAME = c"VK_AMD_gcn_shader";
pub const VK_NV_VIEWPORT_SWIZZLE_EXTENSION_NAME = c"VK_NV_viewport_swizzle";
...
pub const VK_EXT_EXTERNAL_MEMORY_HOST_EXTENSION_NAME = c"VK_EXT_external_memory_host";
pub const VK_NV_EXTERNAL_MEMORY_EXTENSION_NAME = c"VK_NV_external_memory";
...
pub const VK_KHR_DESCRIPTOR_UPDATE_TEMPLATE_EXTENSION_NAME = c"VK_KHR_descriptor_update_template";
...
pub const VK_NV_VIEWPORT_ARRAY2_EXTENSION_NAME = c"VK_NV_viewport_array2";
...
pub const VK_AMD_MIXED_ATTACHMENT_SAMPLES_EXTENSION_NAME = c"VK_AMD_mixed_attachment_samples";
pub const VK_DEBUG_REPORT_OBJECT_TYPE_VALIDATION_CACHE_EXT = VK_DEBUG_REPORT_OBJECT_TYPE_VALIDATION_CACHE_EXT_EXT;
pub const VK_EXT_DEBUG_REPORT_EXTENSION_NAME = c"VK_EXT_debug_report";
pub const VK_AMD_GPU_SHADER_INT16_EXTENSION_NAME = c"VK_AMD_gpu_shader_int16";
...
pub const VK_KHR_EXTERNAL_SEMAPHORE_CAPABILITIES_EXTENSION_NAME = c"VK_KHR_external_semaphore_capabilities";
pub const VK_EXT_EXTERNAL_MEMORY_DMA_BUF_EXTENSION_NAME = c"VK_EXT_external_memory_dma_buf";
pub const __LDBL_REDIR_DECL = name;
pub const VK_AMD_negative_viewport_height = 1;
pub const __OFF64_T_TYPE = __SQUAD_TYPE;
pub const VK_KHR_MULTIVIEW_EXTENSION_NAME = c"VK_KHR_multiview";
pub const VK_AMD_NEGATIVE_VIEWPORT_HEIGHT_EXTENSION_NAME = c"VK_AMD_negative_viewport_height";
pub const GLFW_KEY_5 = 53;
pub const VK_EXT_DIRECT_MODE_DISPLAY_EXTENSION_NAME = c"VK_EXT_direct_mode_display";
pub const __SIZE_FMTx__ = c"lx";
...
pub const VK_KHR_MAINTENANCE3_EXTENSION_NAME = c"VK_KHR_maintenance3";
...
pub const VK_KHR_EXTERNAL_SEMAPHORE_FD_EXTENSION_NAME = c"VK_KHR_external_semaphore_fd";
...
pub const VK_EXT_SAMPLER_FILTER_MINMAX_EXTENSION_NAME = c"VK_EXT_sampler_filter_minmax";
...
pub const VK_AMD_DRAW_INDIRECT_COUNT_EXTENSION_NAME = c"VK_AMD_draw_indirect_count";
pub const __SIZEOF_LONG_DOUBLE__ = 16;
pub const VK_NV_GEOMETRY_SHADER_PASSTHROUGH_EXTENSION_NAME = c"VK_NV_geometry_shader_passthrough";
pub const VK_EXT_SHADER_STENCIL_EXPORT_EXTENSION_NAME = c"VK_EXT_shader_stencil_export";
...
pub const VK_KHR_EXTERNAL_FENCE_CAPABILITIES_EXTENSION_NAME = c"VK_KHR_external_fence_capabilities";
...
pub const VK_AMD_BUFFER_MARKER_EXTENSION_NAME = c"VK_AMD_buffer_marker";
...
pub const VK_EXT_DEBUG_MARKER_EXTENSION_NAME = c"VK_EXT_debug_marker";
...
pub const VK_KHR_16BIT_STORAGE_EXTENSION_NAME = c"VK_KHR_16bit_storage";
...
pub const VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME = c"VK_KHR_get_physical_device_properties2";
...
pub const VK_AMD_RASTERIZATION_ORDER_EXTENSION_NAME = c"VK_AMD_rasterization_order";
pub const VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME = c"VK_EXT_descriptor_indexing";
...
pub const VK_AMD_SHADER_FRAGMENT_MASK_EXTENSION_NAME = c"VK_AMD_shader_fragment_mask";
...
pub const VK_KHR_EXTERNAL_SEMAPHORE_EXTENSION_NAME = c"VK_KHR_external_semaphore";
...
pub const VK_KHR_DEVICE_GROUP_EXTENSION_NAME = c"VK_KHR_device_group";
pub const GLFW_KEY_2 = 50;
pub const VK_KHR_get_physical_device_properties2 = 1;
pub const __GCC_ATOMIC_POINTER_LOCK_FREE = 2;
pub const VK_KHR_STORAGE_BUFFER_STORAGE_CLASS_EXTENSION_NAME = c"VK_KHR_storage_buffer_storage_class";
pub const VK_EXT_SHADER_SUBGROUP_BALLOT_EXTENSION_NAME = c"VK_EXT_shader_subgroup_ballot";
pub const INT8_MAX = 127;
pub const VK_KHR_MULTIVIEW_SPEC_VERSION = 1;
pub const __UINT_FAST8_FMTx__ = c"hhx";
pub const UINT_FAST32_MAX = c_ulong(18446744073709551615);
pub const VK_KHR_MAINTENANCE2_EXTENSION_NAME = c"VK_KHR_maintenance2";
pub const GLFW_VERSION_REVISION = 1;
pub const VK_KHR_PUSH_DESCRIPTOR_EXTENSION_NAME = c"VK_KHR_push_descriptor";
pub const __UINT16_FMTx__ = c"hx";
...
pub const VK_EXT_SHADER_VIEWPORT_INDEX_LAYER_EXTENSION_NAME = c"VK_EXT_shader_viewport_index_layer";
...
pub const VK_AMD_SHADER_EXPLICIT_VERTEX_PARAMETER_EXTENSION_NAME = c"VK_AMD_shader_explicit_vertex_parameter";
...
pub const VK_AMD_SHADER_INFO_EXTENSION_NAME = c"VK_AMD_shader_info";
...
pub const VK_KHR_GET_MEMORY_REQUIREMENTS_2_EXTENSION_NAME = c"VK_KHR_get_memory_requirements2";
pub const VK_AMD_GPU_SHADER_HALF_FLOAT_EXTENSION_NAME = c"VK_AMD_gpu_shader_half_float";
pub const INT_LEAST32_MAX = 2147483647;
pub const VK_EXT_VALIDATION_FLAGS_EXTENSION_NAME = c"VK_EXT_validation_flags";
pub const __INTMAX_MAX__ = c_long(9223372036854775807);
pub const __UINT_LEAST32_FMTx__ = c"x";
pub const __WCHAR_MAX__ = 2147483647;
pub const VK_NV_SAMPLE_MASK_OVERRIDE_COVERAGE_EXTENSION_NAME = c"VK_NV_sample_mask_override_coverage";
...
pub const VK_KHR_GET_SURFACE_CAPABILITIES_2_EXTENSION_NAME = c"VK_KHR_get_surface_capabilities2";
pub const VK_AMD_SHADER_BALLOT_EXTENSION_NAME = c"VK_AMD_shader_ballot";
pub const VK_KHR_MAINTENANCE1_EXTENSION_NAME = c"VK_KHR_maintenance1";
